...
const AggregateCard = ({ data }) => {
    return (
        <div className="border-[1px] dark:border-gray-700 border-[#EDF2F7] dark:bg-gray-800 bg-white rounded-[14px] p-3 flex flex-col gap-3">
            <div className="flex items-center justify-between">
                <div className="h-[40px] w-[40px] rounded-[50%] border-[1px] dark:border-gray-700 border-[#E6E6E6] flex items-center justify-center">
                    <Image
                        width={24}
                        height={24}
            ...
            <div className="flex flex-col gap-1">
                ...
                <span className="text-[24px] dark:text-gray-300 text-[#3A3F51] font-[600]">{data.value}</span>
            </div>
            <div className="flex gap-2 items-center">
                ...
                <span className={`text-[13px] dark:text-gray-300 text-[#606060] ${inter.className}`}>vs. previous month</span>
            </div>
        </div>
    );
}
